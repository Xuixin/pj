...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    ...
    <!-- Hero Section -->
    <div class="bg-gradient-to-br from-blue-600 to-purple-700 text-white py-8 sm:py-12 lg:py-16 mb-6 sm:mb-8 lg:mb-10">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4">
                <i class="fas fa-laptop mr-2 sm:mr-3"></i>
                รายการอุปกรณ์ให้เช่า
            </h1>
            <p class="text-sm sm:text-base lg:text-xl opacity-90 max-w-2xl mx-auto px-4">
    ...
    <!-- Main Content -->
    <div class="container mx-auto px-4 pb-12 sm:pb-16">

        <!-- Filter Section -->
        <div class="filter-section rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-10 border border-white/20 shadow-lg">
            <form method="GET" class="max-w-md mx-auto">
                <label class="block mb-2 sm:mb-3 font-semibold text-gray-700 text-base sm:text-lg">
                    <i class="fas fa-filter mr-2 text-purple-600"></i>
                    กรองตามประเภทอุปกรณ์
                </label>
                <select name="type_id" class="select select-bordered w-full bg-white/80 backdrop-blur-sm border-2 border-purple-200 focus:border-purple-500 transition-all duration-300 text-sm sm:text-base" onchange="this.form.submit()">
